                    ...
                    <div className="wrapper row">
                        ...
                        <div className="details col-md-6">
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    <button 
                                        className="add-to-cart btn btn-default float-right" 
                                        onClick={props.onEditProductClick}
                                    > 
                                        Edit Product
                                    </button>
                                </div>
                            ...
                            <h4 className="price">
                                current price: <span>Ksh {product.price}</span>
                            </h4>
                            <p className="vote">
                            ...
                            <h5 className="sizes">Quantity:
                                <span className="size" title="small">{product.quantity}</span>
                            </h5>

                            <h5 className="colors">colors:
                                <span className="color orange not-available" title="Not In store"></span>
                            ...
                            <div className="action">
                                <button 
                                    ...
                                    onClick={() => props.onBuyButtonClick(product._id)}
                                >
                                    Buy Product
                                </button>
                                <button 
                                    className="add-to-cart btn btn-default float-right" 
                                    onClick={() => props.onDeleteProduct(product._id)}
                                >
                                    Delete Product
                                </button>
                            </div>
